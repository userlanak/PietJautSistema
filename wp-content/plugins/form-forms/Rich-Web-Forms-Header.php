...
<div class='Rich_Web_Header_Main'>
	...
	<div class="Rich_Web_Header_Free_Version">
		<!-- <div class="Rich_Web_Header_Free_Version_Shd">
			<a href="http://rich-web.org/wp-contact-form/" target="_blank" style="text-decoration: none; color: #fff; display: block;">
	...
	<div class="Rich_Web_Header_Contacts">
		<a href="http://rich-web.org/wordpress-form-survey/" target="_blank">Demo</a>
		<a href="https://wordpress.org/plugins/form-forms/#faq" target="_blank">FAQ</a>
		<a href="https://wordpress.org/support/plugin/form-forms/" target="_blank">Support</a>
